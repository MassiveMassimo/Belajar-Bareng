"""
Django settings for belajarbareng project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-frs$ahayrs)nldrv&l#3@7lf6cdzq2eeas72%!aarp(nv63gfr')
...
ROOT_URLCONF = 'belajarbareng.urls'
...
WSGI_APPLICATION = 'belajarbareng.wsgi.application'
